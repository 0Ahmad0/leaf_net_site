...
class AppTextFieldSearchWidget extends StatefulWidget {
  ...
  @override
  State<AppTextFieldSearchWidget> createState() => _AppTextFieldSearchWidgetState();
}

class _AppTextFieldSearchWidgetState extends State<AppTextFieldSearchWidget> {
  void showPassword() {
    setState(() {
